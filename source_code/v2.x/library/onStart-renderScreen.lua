...
function RenderScreen()
  local ScreenTable = {}
  local input_percent  = RoundDownToPrecision(InputBin.getItemsVolume()/InputBin.getMaxVolume())
  ...
  --Parameters (1)
   ScreenTable[1]=[[
     ...
     local input_percent="]] .. ContainerFilledBar(input_percent) .. [["
     local output_percent="]] .. ContainerFilledBar(output_percent) .. [["
   ]]
